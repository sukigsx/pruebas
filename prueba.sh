...
# Asociamos comandos con el paquete que los contiene
...
read opcion
case $opcion in
        1)  crear_usuarios; crear_carpetas; asignar_permisos; configurar_samba #bash $ruta_ejecucion/crear_usuarios_carpetas_samba
            ;;
