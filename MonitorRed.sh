...
do
    ...
    echo -e "   ${azul}20-${rojo} Servicios            ${azul}(${amarillo} $servicios${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${azul}21-${rojo} Ips                  ${azul}(${amarillo} $ips${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${azul}22-${rojo} Dominios             ${azul}(${amarillo} $dominios${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${azul}23-${rojo} Bot de Telegram      ${azul}(${amarillo} $bot_telegram${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${azul}24-${rojo} Automatico a Telegram${azul}(${amarillo} $envio_telegram${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${azul}25-${rojo} Correo Electronico   ${azul}(${amarillo} $configurar_correo${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${azul}26-${rojo} Automatico a Correo  ${azul}(${amarillo} $envio_correo${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${azul}27-${rojo} Restaurar todo  ${azul}(${amarillo} $envio_correo${borra_colores} configurado${azul})${borra_colores}"
    echo -e ""
