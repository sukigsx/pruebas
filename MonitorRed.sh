...
do
    ...
    echo -e "   ${rojo}20-${borra_colores} Servicios            ${azul}(${amarillo} $servicios${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${rojo}21-${borra_colores} Ips                  ${azul}(${amarillo} $ips${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${rojo}22-${borra_colores} Dominios             ${azul}(${amarillo} $dominios${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${rojo}23-${borra_colores} Bot de Telegram      ${azul}(${amarillo} $bot_telegram${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${rojo}24-${borra_colores} Automatico a Telegram${azul}(${amarillo} $envio_telegram${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${rojo}25-${borra_colores} Correo Electronico   ${azul}(${amarillo} $configurar_correo${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${rojo}26-${borra_colores} Automatico a Correo  ${azul}(${amarillo} $envio_correo${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${rojo}27-${borra_colores} Restaurar todo  ${azul}(${amarillo} $envio_correo${borra_colores} configurado${azul})${borra_colores}"
    echo -e ""
