...
do
    ...
    echo -e "   ${azul}10-${borra_colores} Servicios.            ${amarillo} $servicios${borra_colores} configurado."
    echo -e "   ${azul}11-${borra_colores} Ips.                  ${amarillo} $ips${borra_colores} configurado."
    echo -e "   ${azul}12-${borra_colores} Dominios.             ${amarillo} $dominios${borra_colores} configurado."
    echo -e "   ${azul}13-${borra_colores} Bot de Telegram.      ${amarillo} $bot_telegram ${borra_colores} configurado."
    echo -e "   ${azul}13-${borra_colores} Automatico a Telegram.${amarillo} $envio_telegram ${borra_colores} configurado."
    echo -e "   ${azul}15-${borra_colores} Correo Electronico.   ${amarillo} $configurar_correo ${borra_colores} configurado."
    echo -e "   ${azul}16-${borra_colores} Automatico por Correo.${amarillo} $envio_correo ${borra_colores} configurado."
    echo -e ""
