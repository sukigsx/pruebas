...
do
    ...
    echo -e ""
    echo -e "   ${azul}Restauracion del MotitorRed:${borra_colores}"
    echo -e "   ${azul}20-${borra_colores} Borrar Servicios            ${azul}(${amarillo} $servicios${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${azul}21-${borra_colores} Borrar Ips                  ${azul}(${amarillo} $ips${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${azul}22-${borra_colores} Borrar Dominios             ${azul}(${amarillo} $dominios${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${azul}23-${borra_colores} Borrar Bot de Telegram      ${azul}(${amarillo} $bot_telegram${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${azul}24-${borra_colores} Borrar Automatico a Telegram${azul}(${amarillo} $envio_telegram${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${azul}25-${borra_colores} Borrar Correo Electronico   ${azul}(${amarillo} $configurar_correo${borra_colores} configurado${azul})${borra_colores}"
    echo -e "   ${azul}26-${borra_colores} Borrar Automatico a Correo  ${azul}(${amarillo} $envio_correo${borra_colores} configurado${azul})${borra_colores}"
    echo -e ""
