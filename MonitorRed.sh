...
export version="111aaaaaajkhaaartfgfssssaaaaaaacdbdfadgbdgavbcaaaaaaaaaaaa1"
...
software="ping which git diff tail sed figlet" #contiene el software necesario separado por espacios
