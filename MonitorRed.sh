...
export version="1.aaaaafgbdfaaaa"
...
do
    ...
    echo -e "   ${azul} 1-${borra_colores} Comprobar Servicios activos de la misma ip | ${azul}Configuraciones:${borra_colores"
    echo -e "   ${azul} 2-${borra_colores} Comprobar Ips activas                      | ${azul}10-${borra_colores} Servicios            ${azul}(${amarillo} $configurado_servicios${borra_colores} configurado${azul})${borra_colores}"
